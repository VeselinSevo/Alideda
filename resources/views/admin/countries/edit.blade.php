<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-3 flex-wrap">
            <h2 class="font-semibold text-xl text-text leading-tight">Edit Country</h2>
            ...
            <div class="bg-surface border border-border shadow sm:rounded-lg p-6">
                <form method="POST" action="{{ route('admin.countries.update', $country) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="bg-surface text-text placeholder-muted border-border focus:border-primary focus:ring-primary rounded-md shadow-sm w-full px-3 py-2" name="code" maxlength="2"
